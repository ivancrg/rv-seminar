...
\begin{frame}[t]
	...
	\begin{table}
		...
		\begin{tabular}{|p{4cm}||p{5cm}|}
			...
			\hline
			0\$ & neograničeni repozitoriji, issues, bug tracking, project management \\
			\hline
			7\$ & neograničen broj suradnika, napredni alati \\
			\hline
			9\$/korisnik (za timove) & neograničen broj korisnika, team access kontrole, upravljanje korisnicima i projektom \\
			\hline
...
\begin{frame}[t]
	...
	\begin{itemize}
		\begin{overprint}
			...
			\onslide<7>
			\item Početni novac podiže više puta od raznih ulagača
			\item GNOME u svibnju 2018. godine prebacuju preko 400 projekata
			\onslide<8>
			\item Početni novac podiže više puta od raznih ulagača
			\item GNOME u svibnju 2018. godine prebacuju preko 400 projekata
...
\begin{frame}
	...
	\pause
	\begin{itemize}
		\item U siječnju 2017. godine, zbog posljedica napada, administrator je slučajno obrisao bazu podataka te je time 6 sati rada izgubljeno; oporavak se uživo prenosio preko Youtube-a \pause
...
\begin{frame}[t]
	...
	\begin{table}
		...
		\begin{tabular}{|p{2cm}||p{3cm}|p{3cm}|}
			...
			\hline
			Bitbucket & 2012. pokrenut; 2014. korporacija & otključano kupnjom verzije \\
			\hline
		\end{tabular}
		\end{center}
	\end{table}
